"""Regression checks for the cobalt-trace-slo-dock casebook."""
...
from casebook.harness import assert_expected, cobalt_trace_slo_dock_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cobalt_trace_slo_dock_summary(), assert_expected())
